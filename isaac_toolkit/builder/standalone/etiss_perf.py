...
class ETISSPerfStandaloneBuilder(ETISSStandaloneBuilder):
...
def invoke_etiss_perf_builder(
    ...
    builder = ETISSPerfStandaloneBuilder(
        make_dir,
        arch=arch,
        abi=abi,
        xlen=xlen,
    ...
    if label is None:
        # TODO: add timestamp?
        label = f"{program}-etiss_perf-build"
