...
def choose_bbs(sess: Session, threshold: float = 0.9, min_weight: float = 0.01, max_num: Optional[int] = None, force: bool = False):
    ...
    llvm_bbs_artifacts = filter_artifacts(artifacts, lambda x: x.flags & ArtifactFlag.TABLE and x.name == "llvm_bbs_new")
