...
from .stage.bench import run_mlonmcu_bench
from .stage.trace import run_mlonmcu_trace
...
def run_full_mlonmcu_flow(
    sess: Session,
    mlonmcu_args: List[str],
    unmangle: bool = False,
    force: bool = False,
    progress: bool = False,
    report_fmt="md",
    ...
    logger.info("Running full MLonMCU flow...")
    run_mlonmcu_bench(mlonmcu_args, load=True)
    run_mlonmcu_trace(mlonmcu_args, load=True)
    # load_artifacts(
    #     sess,
    #     elf_file=elf_file,
